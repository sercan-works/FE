...
const ComponentsDashboard = () => {
    ...
    const revenueChart: any = {
        series: [
            {
                name: 'Psk. Ahmet Yılmaz',
                data: [16800, 16800, 15500, 17800, 15500, 17000, 19000, 16000, 15000, 17000, 14000, 17000],
            },
            {
                name: 'Psk. Ayşe Yılmaz',
                    ...
                    <div className="mb-6 grid gap-6 xl:grid-cols-3">
                        <div className="panel h-full xl:col-span-2">
                            <div className="mb-5 flex items-center justify-between dark:text-white-light">
                                <h5 className="text-lg font-semibold">Randevu Durumu</h5>
                            ...
                            <p className="text-lg dark:text-white-light/90">
                                Toplam Randevular <span className="ml-2 text-primary">$10,840</span>
                            </p>
                        ...
                        <div className="panel h-full">
                            <div className="mb-5 flex items-center">
                                <h5 className="text-lg font-semibold dark:text-white-light">Danışan Durumu</h5>
                            </div>
                            <div>
                                <div className="rounded-lg bg-white dark:bg-black">
                                    {isMounted ? (
